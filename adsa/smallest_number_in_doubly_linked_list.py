...
class DoublyLinkedList:
    ...
    def smallest_number(self):
        ...
        mi=float('inf')
        while curr:
            if mi>curr.data:           #compares the min value with the data of the node
                mi=curr.data             #assigns the min value
            curr=curr.next
        print(mi)
...
for i in l:
    dllist.append(i)
dllist.print_list()
print("The smallest number in the doubly linked list is: ")
dllist.smallest_number()
